...
mod tests {
    ...
    fn test_encoderfile_config() -> EncoderfileConfig {
        EncoderfileConfig {
            ...
            path: ModelPath::Directory(std::path::PathBuf::from("models/dummy_sequence_classifier")),
    ...
    fn test_model_config() -> ModelConfig {
        let config_json = include_str!("../../../../../models/dummy_sequence_classifier/config.json");
