...
#[allow(dead_code)]
const TRANSFORM: Option<&'static str> = Some(include_str!("TRANSFORM_PATH")));
"##;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let write_dir = std::path::Path::new(&std::env::var("OUT_DIR").unwrap())
        .join("generated/transform/transform.rs");
